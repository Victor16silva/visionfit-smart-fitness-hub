...
export default function CreateWorkoutModal({ 
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      toast.success(`Treino criado para ${user.full_name}`);
      onClose();
      setFormData({
        name: "",
        division: "A",
    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-card rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto animate-fade-in">
        ...
        <div className="flex items-center justify-between p-4 border-b border-border sticky top-0 bg-card z-10">
          <h2 className="text-lg font-bold text-foreground">Treino para {user.full_name}</h2>
          <button 
            onClick={onClose}
        ...
        <div className="p-4 space-y-4">
          ...
          {/* Focus */}
          <div>
            <label className="block text-xs text-muted-foreground mb-1.5">Foco</label>
            <Input
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div>
              <label className="block text-xs text-muted-foreground mb-1.5">Carga (kg)</label>
              <Input
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">4 séries • 8 reps • 45s</p>
                      </div>
                    </div>
                    <button 
          ...
          >
            ...
            {loading ? "Criando..." : "Criar e Atribuir Treino"}
          </Button>
        </div>
      </div>
    </div>
