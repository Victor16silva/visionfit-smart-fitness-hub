...
DROP POLICY IF EXISTS "Users can view their own messages" ON public.trainer_chat;
DROP POLICY IF EXISTS "Users can send messages" ON public.trainer_chat;
DROP POLICY IF EXISTS "Users can update messages they received" ON public.trainer_chat;
